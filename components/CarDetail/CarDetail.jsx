      ...
      {selectedCar && (
        <S.Wrapper>
          <S.InnerWrapper>
            <S.ImageWrapper>
              <S.CarImage
                src={selectedCar.attribute.imageUrl}
                alt="altimobility"
              />
            </S.ImageWrapper>
            <S.OverviewWrapper>
              <S.OverviewStart>
                <S.BrandText>{selectedCar.attribute.brand}</S.BrandText>
                <S.NameText>{selectedCar.attribute.name}</S.NameText>
              </S.OverviewStart>
              <S.OverviewEnd>
                월 {selectedCar.amount.toLocaleString("ko-KR")} 원
              </S.OverviewEnd>
            </S.OverviewWrapper>
            <S.AttributeCategory>
              {CAR_DETAIL_CATEGORY.DETAIL_INFO}
            </S.AttributeCategory>
            <CarDetailItem
            ...
            />
            <CarDetailItem
              name={CAR_DETAIL_INFO.AVAILABLE_DATE}
              date={selectedCar.startDate}
            />
            <S.AttributeCategory>
              {CAR_DETAIL_CATEGORY.INSURANCE}
            </S.AttributeCategory>
